...
from .models import State, StateData, Story, Intention, IntentionSet, Patch, PatchOp
...
class SchemaValidator:
    ...
    def validate_state(self, state_data: Dict[str, Any], schema_version: str = "1.0.0") -> ValidationResult:
    ...
    def _validate_business_rules(self, state_data: Dict[str, Any], result: ValidationResult):
    ...
    def _validate_priority_dependencies(self, state_data: Dict[str, Any], result: ValidationResult):
    ...
    def _validate_auth_consistency(self, state_data: Dict[str, Any], result: ValidationResult):
    ...
    def _validate_timeline_consistency(self, state_data: Dict[str, Any], result: ValidationResult):
    ...
    def _validate_story_naming(self, state_data: Dict[str, Any], result: ValidationResult):
    ...
    def _validate_intention_patterns(self, intentions_data: Dict[str, Any], result: ValidationResult):
        ...
        for i, intention in enumerate(items):
            ...
            if intention['action'] in ['move', 'modify'] and not intention.get('reason'):
                result.add_warning(
                    f"items[{i}].reason",
    ...
    def _generate_optimization_suggestions(self, state_data: Dict[str, Any], result: ValidationResult):
        ...
        if duplicates:
            result.add_suggestion(
                ...
                {"recommendation": "consolidate_criteria", "duplicates": list(duplicates.keys())}
            )
